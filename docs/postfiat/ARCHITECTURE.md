...
- The same workflow publishes and fetches public wallet inbox directory events on Nostr relays, allowing share-by-wallet-address without putting document links or access grants on-chain.
